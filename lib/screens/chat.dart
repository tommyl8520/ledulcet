...
import 'package:ledulcet/models/chat.dart';
import 'package:ledulcet/models/conversation.dart';
import 'package:ledulcet/models/user.dart';
import 'package:ledulcet/widgets/ChatMessageListItemWidget.dart';
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: IconButton(
                  ...
                  onPressed: () {
                    setState(() {
                      _conversationList.conversations[0].chats.insert(0,
                          Chat(myController.text, '21min ago', _currentUser));
