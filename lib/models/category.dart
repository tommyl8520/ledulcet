...
import 'package:ledulcet/config/ui_icons.dart';
import 'package:ledulcet/models/product.dart';
    ...
    this._list = [
      ...
      new Category('Fourniture', UiIcons.living_room, false, [
        ...
        new Product('Steel Cutlery Set Gold Cutlery', 'img/home7.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product('Silicone Kitchen Organizer Insulated ', 'img/home8.webp',
            80, 42.63, 200, 2554, 3.1, 10.5),
        new Product('Non Stick Wooden Handle Silicone ', 'img/home9.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
      ...
      new Category('Watch', UiIcons.watch, false, [
        new Product('Men Wrist Watch Stainless', 'img/watch1.webp', 80, 42.63,
            200, 2554, 3.1, 10.5),
        new Product('Reef Tiger RT Mens Sport Watches', 'img/watch2.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product('Sport watch Waterproof', 'img/watch3.webp', 80, 42.63, 200,
            2554, 3.1, 10.5),
        new Product('Sport Watch Black Military', 'img/watch4.webp', 80, 42.63,
            200, 2554, 3.1, 10.5),
        ...
        new Product('Digital Display Bracelet Watch', 'img/watch6.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product('Men Sports Watch Silicone Watchband', 'img/watch7.webp',
            80, 42.63, 200, 2554, 3.1, 10.5),
        new Product('Fashion Waterproof Men Digital Watches', 'img/watch8.webp',
            80, 42.63, 200, 2554, 3.1, 10.5),
      ...
      new Category('Sport', UiIcons.sport, false, [
        new Product('Back Shoulder Posture Correction', 'img/sport1.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product('Ankle Support Brace Elasticity', 'img/sport2.webp', 80,
            42.63, 200, 2554, 3.1, 10.5),
        new Product('Men Women Swimming Goggles', 'img/sport3.webp', 80, 42.63,
            200, 2554, 3.1, 10.5),
        new Product('Yosoo Knee pad Elastic', 'img/sport4.webp', 80, 42.63, 200,
            2554, 3.1, 10.5),
        new Product('Spring Hand Grip Finger Strength', 'img/sport5.webp', 80,
